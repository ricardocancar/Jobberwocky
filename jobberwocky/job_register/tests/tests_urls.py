...
from job_register.views import Create, Search_v1, Search_v2, SignIn
...
class TestUrls(SimpleTestCase):
    ...
    def test_search_v2_url_is_resolved(self):
        ...
        self.assertEquals(resolve(url).func.view_class, Search_v2)

    def test_signin_url_is_resolved(self):
        url = reverse("job_register:signin")
